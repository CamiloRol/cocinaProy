    ...
    <h1 className="text-center mb-4" style={{ color: '#ff7f50' }}>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            <div className="mb-3">
                ...
                {errors.name?.type === 'required' && <p className="text-danger">Este campo es requerido</p>}
                {errors.name?.type === 'maxLength' && <p className="text-danger">El nombre no puede exceder los 20 caracteres</p>}
            </div>
            ...
            <div className="mb-3">
                ...
                {errors.email?.type === 'required' && <p className="text-danger">Este campo es requerido</p>}
                {errors.email?.type === 'pattern' && <p className="text-danger">El email no es válido</p>}
            </div>
